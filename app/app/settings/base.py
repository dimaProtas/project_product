...
#Здесь нужно добавить ещё один parent, так как мы лежим еще в одной директории и base dir изменяеться
...
# from app.hitcount.middleware import hit_count_middleware
